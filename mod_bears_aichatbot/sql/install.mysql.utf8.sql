--
-- SQL installation script for mod_bears_aichatbot
-- Creates tables for usage tracking and keyword analytics
--
...
-- This table stores operational state like collection_id
--
