<?php
/**
 * Custom field for stop words with proper default value handling
 */
...
class JFormFieldStopwords extends TextareaField
{
    protected $type = 'Stopwords';
